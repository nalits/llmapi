...
import { deleteSettingByKey, upsertSettingForUsers } from '../migrate/settings-compat.js';
...
export function up(db: Db): void {
  deleteSettingByKey(db, DOWNGRADE_MARKER_KEY);
...
export function down(db: Db): void {
  ...
  upsertSettingForUsers(db, DOWNGRADE_MARKER_KEY, new Date().toISOString());
}
